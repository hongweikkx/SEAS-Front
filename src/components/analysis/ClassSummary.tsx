...
export default function ClassSummary({ examId }: ClassSummaryProps) {
  ...
  const sortedClassDetails = data?.classDetails
    ? sortedData(sortByClassName(data.classDetails))
    : []
            ...
            <tbody>
              {data?.overallGrade && (
                <tr className="border-b border-border/40 bg-primary/5 font-semibold">
                  <td className="py-3 px-5 text-center">{data.overallGrade.className}</td>
                  <td className="py-3 px-5 text-center">{data.overallGrade.totalStudents}</td>
                  <td className="py-3 px-5 text-center">{formatNumber(data.overallGrade.fullScore)}</td>
                  <td className="py-3 px-5 text-center">{formatNumber(data.overallGrade.avgScore)}</td>
                  <td className="py-3 px-5 text-center">{formatNumber(data.overallGrade.highestScore)}</td>
                  <td className="py-3 px-5 text-center">{formatNumber(data.overallGrade.lowestScore)}</td>
                  <td className="py-3 px-5 text-center">—</td>
                  <td className="py-3 px-5 text-center">{formatNumber(data.overallGrade.difficulty)}</td>
                  <td className="py-3 px-5 text-center">{formatNumber(data.overallGrade.stdDev)}</td>
                  <td className="py-3 px-5 text-center">{formatNumber(data.overallGrade.discrimination)}</td>
                </tr>
              )}
